...
namespace ShortestCycleDirGraph.Pages.Settings
{
        ...
        : NotifyPropertyChanged
    {
        ...
        public AppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "ciemny", Source = AppearanceManager.DarkThemeSource });
            this.themes.Add(new Link { DisplayName = "jasny", Source = AppearanceManager.LightThemeSource });
